...
const GitHubStats = () => {
  ...
  return (
    <div className="text-black dark:text-white p-6 rounded-lg transition-colors duration-300">
      <h2 className="text-2xl font-bold mb-4 text-center">GitHub Stats</h2>

      <div className="bg-white text-black dark:bg-[#111827] dark:text-white p-4 rounded-2xl border border-gray-300 dark:border-gray-700 shadow-lg shadow-green-500/10 hover:shadow-green-500/30 transition duration-300 w-full max-w-2xl mx-auto space-y-4">
        <img
